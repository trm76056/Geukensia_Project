#this is to figure out which MA30 is so far removed from the others
#not MA12
...
files = c("GA1-30_quant.sf","GA3-30_quant.sf","GA4-30_quant.sf","GA5-30_quant.sf",
          ...
          "MA12-30_quant.sf","MA14-30_quant.sf", "MA15-30_quant.sf",
...
sigFDR_GACvsMAC.df <- data.frame(tt_GACvsMAC.df[tt_GACvsMAC.df$FDR<0.05,])
write.table(sigFDR_GACvsMAC.df,
            file = "~/Documents/Research/Geukensia/sigFDR_GACvsMAC.txt",
            quote = FALSE)
...
write.table(topTags(tr_GACvsMAC,n=30),
            ...
            quote=FALSE)
is.de_GACvsMAC <- decideTestsDGE(tr_GACvsMAC, adjust.method="fdr",p.value=0.05) #p.value is the FDR
...
sigFDR_GA20vsMA20.df <- data.frame(tt_GA20vsMA20.df[tt_GA20vsMA20.df$FDR<0.05,])
write.table(sigFDR_GA20vsMA20.df,
            file = "~/Documents/Research/Geukensia/sigFDR_GA20vsMA20.txt",
            quote = FALSE)
...
sigFDR_GA30vsMA30.df <- data.frame(tt_GA30vsMA30.df[tt_GA30vsMA30.df$FDR<0.05,])
write.table(sigFDR_GA30vsMA30.df,
            file = "~/Documents/Research/Geukensia/sigFDR_GA30vsMA30.txt",
            quote = FALSE)
...
save_plot("Cons_Differences_noMA13-30_all.png",cons_plots,ncol=2,nrow=2)
...
sigFDR_GA20vsGA30.df <- data.frame(tt_GA20vsGA30.df[tt_GA20vsGA30.df$FDR<0.05,])
write.table(sigFDR_GA20vsGA30.df,
            file = "~/Documents/Research/Geukensia/sigFDR_GA20vsGA30.txt",
            quote = FALSE)
...
sigFDR_MA20vsMA30.df <- data.frame(tt_MA20vsMA30.df[tt_MA20vsMA30.df$FDR<0.05,])
write.table(sigFDR_MA20vsMA30.df,
            file = "~/Documents/Research/Geukensia/sigFDR_MA20vsMA30.txt",
            quote = FALSE)
...
save_plot("Temp_Differences_noMA13-30_all.png",temp_plots,device="png",ncol=2)
